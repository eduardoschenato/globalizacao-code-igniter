...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<?php echo $mapMenu; ?> - <?php echo $titleMenu; ?>">
    <meta name="author" content="Eduardo Schenato dos Santos">
    
    <meta property="og:title" content="<?php echo $mapMenu; ?> - <?php echo $titleMenu; ?>">
    <meta property="og:site_name" content="<?php echo $titleMenu; ?>">
    <meta property="og:description" content="<?php echo $mapMenu; ?> - <?php echo $titleMenu; ?>">
    <meta property="og:image" content="<?php echo base_url(); ?>public/img/home-bg.png">

    <title><?php echo $mapMenu; ?> - <?php echo $titleMenu; ?></title>
