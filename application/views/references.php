...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<?php echo $referencesMenu; ?> - <?php echo $titleMenu; ?>">
    <meta name="author" content="Eduardo Schenato dos Santos">
    
    <meta property="og:title" content="<?php echo $referencesMenu; ?> - <?php echo $titleMenu; ?>">
    <meta property="og:site_name" content="<?php echo $titleMenu; ?>">
    <meta property="og:description" content="<?php echo $referencesMenu; ?> - <?php echo $titleMenu; ?>">
    <meta property="og:image" content="<?php echo base_url(); ?>public/img/home-bg.png">

    <title><?php echo $referencesMenu; ?> - <?php echo $titleMenu; ?></title>
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <ul>
              <li><a href="https://startbootstrap.com/template-overviews/clean-blog/" target="_blank"><?php echo $theme; ?></a></li>
              <li><?php echo $map; ?></li>
              <li><?php echo $cms; ?></li>
