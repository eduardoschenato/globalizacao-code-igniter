...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<?php echo $titleMenu; ?>">
    <meta name="author" content="Eduardo Schenato dos Santos">
    
    <meta property="og:title" content="<?php echo $titleMenu; ?>">
    <meta property="og:site_name" content="<?php echo $titleMenu; ?>">
    <meta property="og:description" content="<?php echo $titleMenu; ?>">
          ...
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              ...
              <span class="subheading">
                <?php echo $subtitle1; ?> <br>
                <?php echo $subtitle2; ?> <br>
                <?php echo $subtitle3; ?></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <?php foreach($posts as $post) { ?>
            <div class="post-preview">
              <a href="<?php echo base_url() . $lang . "/post/" . $post["id"]; ?>">
              ...
              <p class="post-meta">
                ...
                em <?php echo getDateShowFormat($post["date"]); ?>
              </p>
            </div>
            <hr>
          <?php } ?>
